...
router.get(
  "/google/secrets",
  passport.authenticate("google", { failureRedirect: `${process.env.FRONTEND_ORIGIN}/signin` }),
  oauthSuccess
);
...
router.get(
  "/github/callback",
  passport.authenticate("github", { failureRedirect: `${process.env.FRONTEND_ORIGIN}/signin` }),
  oauthSuccess
);
